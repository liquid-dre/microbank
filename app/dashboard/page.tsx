...
import { ArrowDownCircle, ArrowUpCircle, Check, ChevronsUpDown } from "lucide-react";
      ...
      <div className="mb-8 p-6 rounded-xl shadow border bg-white">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <AreaChart data={chartData}>
            ...
            <YAxis />
            <Tooltip />
            <Area type="monotone" dataKey="deposit" stroke="var(--color-primary)" fill="url(#depositColor)" />
            <Area type="monotone" dataKey="withdrawal" stroke="var(--color-accent)" fill="url(#withdrawColor)" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-4 mb-4">
        ...
        <Popover open={typeOpen} onOpenChange={setTypeOpen}>
          <PopoverTrigger asChild>
            ...
            >
              {
                transactionTypes.find((opt) => opt.value === typeFilter)?.label ||
                "Select type"
              }
